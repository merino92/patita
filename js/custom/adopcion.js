...
function ValidarCampos(){
  ...
  if($("#nombreadoptado").val()==""){
      respuesta=false;
     $('#nombreadoptado').css('border-color', 'Red');
  }else{
    $('#nombreadoptado').css('border-color', 'lightgrey');
  }
  if($("#color").val()==""){
      respuesta=false;
  ...
  if($("#edadadoptado").val()==""){
      respuesta=false;
     $('#edadadoptado').css('border-color', 'Red');
  }else{
    $('#edadadoptado').css('border-color', 'lightgrey');
  }
  if($("#tamano").val()==""){
      respuesta=false;
     $('#tamano').css('border-color', 'Red');
  }else{
    $('#tamano').css('border-color', 'lightgrey');
  }
  if($("#estadosalud").val()==""){
      respuesta=false;
     $('#estadosalud').css('border-color', 'Red');
  }else{
    $('#estadosalud').css('border-color', 'lightgrey');
  }
